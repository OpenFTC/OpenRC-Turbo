...
public class CurrentGame {
  ...
  // TFOD_CURRENT_GAME_NAME ends up in the tooltips for some TensorFlow Object Detection blocks.
  public static final String TFOD_CURRENT_GAME_NAME = "POWERPLAY";
  // TFOD_CURRENT_GAME_NAME_NO_SPACES ends up in the label shown on some TensorFlow Object Detection
  // blocks.
  public static final String TFOD_CURRENT_GAME_NAME_NO_SPACES = "POWERPLAY";
  // TFOD_CURRENT_GAME_BLOCKS_FIRST_NAME ends up in the label shown on the deprecated
  // tfodCurrentGame_* blocks
  public static final String TFOD_CURRENT_GAME_BLOCKS_FIRST_NAME = "TensorFlowObjectDetectionPOWERPLAY";
  // TFOD_CURRENT_GAME_IDENTIFIER_FOR_FTCJAVA ends up in the java code generated by the deprecated
  // tfodCurrentGame_* blocks. It must be a valid java identifier.
  public static final String TFOD_CURRENT_GAME_IDENTIFIER_FOR_FTCJAVA = "tfodPOWERPLAY";

  // VUFORIA_CURRENT_GAME_NAME ends up in:
  // toolbox sub-category names in Vuforia
  // tooltip for Vuforia blocks
  public static final String VUFORIA_CURRENT_GAME_NAME = "POWERPLAY";
  // VUFORIA_CURRENT_GAME_BLOCKS_FIRST_NAME ends up in the label shown on Vuforia blocks.
  public static final String VUFORIA_CURRENT_GAME_BLOCKS_FIRST_NAME = "VuforiaPOWERPLAY";
  ...
  public static final String VUFORIA_CURRENT_GAME_IDENTIFIER_FOR_FTCJAVA = "vuforiaPOWERPLAY";
}
